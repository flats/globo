...
module.exports = function(environment) {
  var ENV = {
    ...
    contentSecurityPolicy: { 'script-src': "'self' 'unsafe-inline' 'unsafe-eval' https://connect.facebook.net http://connect.facebook.net", 'style-src': "'self' 'unsafe-inline'", 'default-src': "'self' http://staticxx.facebook.com https://www.facebook.com http://connect.facebook.net https://connect.facebook.net", 'img-src': "'self' https://www.facebook.com", 'connect-src': "'self' *" },
    baseURL: '/',
    locationType: 'auto',
    EmberENV: {
      FEATURES: {
